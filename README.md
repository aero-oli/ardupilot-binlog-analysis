...
This skill cannot declare an aircraft safe to fly. It is designed to produce evidence-backed findings, confidence levels, missing-data notes, and recommended checks. Mechanical inspection, bench testing, configuration review, and controlled ground checks are still required after any serious log finding.
