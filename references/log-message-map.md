...
| Motors/servos | RCOU, PARM | Servo/motor channel outputs. Use `SERVOx_FUNCTION` from PARM to identify motor channels before assigning motor meaning. |
...
- RCOU.C*: output PWM-like values; use `SERVOx_FUNCTION` output mapping before assigning motors.
